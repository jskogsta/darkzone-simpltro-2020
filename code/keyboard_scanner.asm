/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    ~~~~~~~~~~~~~~~~~~~
        By: TWW/CTR
        Url: https://codebase64.org/doku.php?id=base:scanning_the_keyboard_the_correct_and_non_kernal_way
    ...
    ~~~~~
      Example Code:
            ...
            // Lets check the keyboard and see if we have to exit.. 
            // Using the routine (API)
            //   Call the routine with a JSR and read the Carry to determine if any valid input is returned.
    ...
    THIS CODE CHECKS FOR SPACE ONLY AND DOES SOMETHING:

            // Lets check the keyboard and see if (space) has been pressed
            jsr Keyboard
            bcs keyboard_not_pressed
            cmp #$20                    // $20 is (space). see keyboard routine for details on other keys
            beq space_pressed
            jmp keyboard_not_pressed
        space_pressed:
            jsr exit_back_to_basic
