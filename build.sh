#!/bin/bash
# Build Simpltro using KickAssembler 5.x + kickass-cruncher-plugins 2.0
...
#   java cml.kickass.KickAssembler dz_simpltro_2020_v0.2.1.asm

KICKASS_CP="${KICKASS_CP:-$CLASSPATH}"
java -cp "$KICKASS_CP" cml.kickass.KickAssembler dz_simpltro_2020_v0.2.1.asm
